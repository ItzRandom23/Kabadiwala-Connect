...
- The provided directory is not a Git working tree at audit time (`git status` reported “not a git repository”); verification therefore uses the files and generated/runtime test results available in the directory.
