...
8. Added role-safe Admin authentication/navigation and an operator console for recycler authorization, disputes, payments, formal anomalies, validated price tools and dataset export.
9. Promoted pickup reliability, offer lifecycle, demand intelligence/update, safety routing, material passport, anomaly and settlement review actions into the operational screens.

## Follow-on implementation order

The remaining partial items are deliberately isolated so the working demo remains stable:

- Promote remaining household/pickup/handover evidence into dedicated deep-detail destinations; the primary actions are now visible inline.
