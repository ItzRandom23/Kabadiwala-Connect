...
- Admin: a separate capability-gated operator console is reachable only after `/auth/admin-login`; it is not included in household, Kabadiwala or Recycler navigation.
