...
async function main() {
  ...
  await prisma.householdListing.upsert({ where: { id: 'dev-household-a-pet' }, update: { householdId: householdA.id, materialCategory: MaterialCategory.PLASTIC, estimatedWeight: 12, condition: 'INTACT', areaName: 'Kothrud, Pune', status: 'POSTED' }, create: { id: 'dev-household-a-pet', householdId: householdA.id, materialCategory: MaterialCategory.PLASTIC, estimatedWeight: 12, condition: 'INTACT', areaName: 'Kothrud, Pune', status: 'POSTED' } });
  await prisma.householdListing.upsert({ where: { id: 'dev-household-a-newspaper' }, update: { householdId: householdA.id, materialCategory: MaterialCategory.OTHER, estimatedWeight: 8, condition: 'INTACT', areaName: 'Kothrud, Pune', status: 'POSTED' }, create: { id: 'dev-household-a-newspaper', householdId: householdA.id, materialCategory: MaterialCategory.OTHER, estimatedWeight: 8, condition: 'INTACT', areaName: 'Kothrud, Pune', status: 'POSTED' } });
  await prisma.householdListing.upsert({ where: { id: 'dev-household-b-metal' }, update: { householdId: householdB.id, materialCategory: MaterialCategory.COPPER, estimatedWeight: 10, condition: 'DAMAGED', areaName: 'Baner, Pune', status: 'POSTED' }, create: { id: 'dev-household-b-metal', householdId: householdB.id, materialCategory: MaterialCategory.COPPER, estimatedWeight: 10, condition: 'DAMAGED', areaName: 'Baner, Pune', status: 'POSTED' } });
